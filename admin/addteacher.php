...
<section class="content">
  ...
  <div class="row">
<form action="addteacherAction.php" role="form" name="myForm"   method="POST" enctype="multipart/form-data">
      <h3 class="text-center"><?php echo $msg ; ?></h3>
      <div class="form-group">
          <label for="firstName" class="col-sm-3 control-label">First Name*</label>
          <div class="col-sm-9">
              <input type="text" id="firstName" placeholder="First Name" name="fname" class="form-control" value="<?php if(!empty($_SESSION["fname"])){ echo $_SESSION["fname"]; } ?>"  autofocus >
      ...
      <div class="form-group">
          ...
          <div class="col-sm-9">
              <input type="text" id="lastName" placeholder="Last Name" name="lname" class="form-control" value="<?php  if(!empty($_SESSION["lname"])){ echo $_SESSION["lname"]; } ?>" >
      ...
      <div class="form-group">
          ...
          <div class="col-sm-9">
              <input type="text" id="userName" placeholder="User Name" class="form-control" name= "username" value="<?php if(!empty($_SESSION["username"])){ echo $_SESSION["username"]; } ?>" >
